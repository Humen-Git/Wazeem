...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        await message.reply_video(
            ...
            caption=f"<b>ᴛʜᴀɴᴋ ʏᴏᴜ ғᴏʀ ᴀᴅᴅɪɴɢ{message.chat.title} .\n\nɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴀɴs/ᴅᴏᴜʙᴛs ᴀʙᴏᴜᴛ ᴍᴇ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴏᴡɴᴇʀ✨</b>",
            reply_markup=reply_markup)
    else:
        for u in message.new_chat_members:
                ...
                caption=f"<b>ʜʏʏ, {u.mention},</b><b> ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ</b><b>{message.chat.title} </b>\n\n<b>ʜᴏᴡ ᴀʀᴇ ʏᴏᴜ</b>",
                reply_markup=InlineKeyboardMarkup(buttons))
